<template>
  <div class="link_category">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>链接分类目录</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图 -->
    <el-card>
      <!-- 添加角色按钮区域 -->
    ...
    >
      ...
      >
        ...
        <el-form-item label="链接" prop="link_id">
          <el-input v-model="addlink.link_id"></el-input>
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        link_id: [{ required: true, message: '请输入ID', trigger: 'blur' }]
      }
    }
  },
  created() {
